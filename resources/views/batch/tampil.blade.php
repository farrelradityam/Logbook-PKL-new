<x-layout>
    ...
    <div class="flex items-center justify-between">
        <h4 class="text-xl font-semibold mb-4">List Angkatan</h4>
        <div class="mb-5 ">
            <a href="{{ route('batch.tambah') }}" class="px-4 py-2 bg-blue-500 hover:bg-sky-700 text-white rounded-md ">Tambah Data</a>
        </div>
    </div>
